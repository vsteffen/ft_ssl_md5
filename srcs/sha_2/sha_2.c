...
void		sha_2_update_32(t_sha_2 *sha_2, uint8_t *bloc, uint32_t *digest, uint32_t *k)
{
	t_sha_2_w_32		*h;

	h = (t_sha_2_w_32 *)digest;
	sha_2_compute_32(h, bloc, k);
	(void)sha_2;
}

void		sha_2_update_64(t_sha_2 *sha_2, uint8_t *bloc, uint64_t *digest, uint64_t *k)
{
	t_sha_2_w_64		*h;

	h = (t_sha_2_w_64 *)digest;
	sha_2_compute_64(h, bloc, k);
	(void)sha_2;
}

void		sha_2_update(t_sha_2 *sha_2, uint8_t *bloc, uint64_t *digest, uint64_t *k)
{
	if (sha_2->type < 2)
