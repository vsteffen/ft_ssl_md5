...
int			md5_open_file(t_ssl *ssl, t_ssl_in *input)
{
	int				fd;
	struct stat		st;
...
int8_t		handle_md5_file(t_ssl *ssl, t_ssl_in *input, uint8_t *digest, uint32_t t[65])
{
	int		fd;
...
int8_t		handle_md5_raw(t_ssl *ssl, t_ssl_in *input, uint8_t *digest, uint32_t t[65])
{
